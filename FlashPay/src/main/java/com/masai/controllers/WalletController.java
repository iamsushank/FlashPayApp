...
public class WalletController {
	...
	public ResponseEntity<Transaction> WalletTOWalletTransfer(@PathVariable("sourceMobileNo") String sourceMobileNo,
			@PathVariable("tragetMobileNo") String targetMobileNo, @PathVariable("amount") Double amount,@PathVariable("uniqueId") String uniqueId)
	...
	public ResponseEntity<Customer> addMoneyFromBankToWallet(String accountNumber, String uniqueId, Double amount) throws Exception {
		Customer customer = walletServiceImpl.addMoney(accountNumber, uniqueId, amount);
